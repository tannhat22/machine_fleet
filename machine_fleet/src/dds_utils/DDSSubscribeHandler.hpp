...
#ifndef MACHINE_FLEET__SRC__DDS_UTILS__DDSSUBSCRIBEHANDLER_HPP
#define MACHINE_FLEET__SRC__DDS_UTILS__DDSSUBSCRIBEHANDLER_HPP
...
#endif // MACHINE_FLEET__SRC__DDS_UTILS__DDSSUBSCRIBEHANDLER_HPP
