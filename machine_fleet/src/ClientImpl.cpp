...
Client::ClientImpl::ClientImpl(const ClientConfig &_config) : client_config(_config) {}
...
void Client::ClientImpl::start(Fields _fields) { fields = std::move(_fields); }

bool Client::ClientImpl::send_machine_state(const messages::MachineState &_new_machine_state) {
...
bool Client::ClientImpl::read_machine_request(messages::MachineRequest &_machine_request) {
...
bool Client::ClientImpl::read_station_request(messages::StationRequest &_station_request) {
